Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.OrganizationV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.organizationv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#nameOrgPanelGrid');
                                    if(grid.isHidden()){
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#nameOrgPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="nameOrgPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#nameOrgGrid');
                    ...
                    },
                    {
                        ...
                        emptyText: 'Ingrese Fecha de Inicio',
                        name: 'foundationDateOrg',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    },
                    {
                        ...
                        emptyText: 'Ingrese Fecha de Disolución',
                        name: 'dissolutionDateOrg',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Inicio Período Contable',
                        emptyText: 'Ingrese Inicio Período Contable',
                        name: 'accountingPeriodStartDateTimeOrg',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Fin Período Contable',
                        emptyText: 'Ingrese Fin Período Contable',
                        name: 'accountingPeriodEndDateTimeOrg',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'playingRegistryAuthorityOrgGrid',
                                autoScroll: true,
                                height: '',
                                store: new Ext.data.Store({
                                ...
                                xtype: 'button',
                                itemId: 'playingRegistryAuthorityOrgPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#playingRegistryAuthorityOrgPanelGrid');
                                    if(grid.isHidden()){
                                        grid.setVisible(true);
                                        grid.on('afterlayout', function(){
                                            this.center();
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'playingRegistryAuthorityOrgPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#playingRegistryAuthorityOrgPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="playingRegistryAuthorityOrgPanelGridButton"]');
                                                button[button.length-1].toggle();
                                            }
                                        });
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            tooltip: 'Agregar',
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#playingRegistryAuthorityOrgGrid');
                                                var store = screen[screen.length-1].getStore();
