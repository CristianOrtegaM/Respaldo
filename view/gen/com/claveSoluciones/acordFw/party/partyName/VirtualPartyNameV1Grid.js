Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.partyName.VirtualPartyNameV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.virtualpartynamev1grid',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.party.partyName.VirtualPartyNameV1',
    initComponent: function() {
        this.columns = [
            ...
            {
                header: 'Uso',
                dataIndex: 'usageCodeVpn',
                sortable: true,
                align: 'left',
                hidden: false,
                renderer: function (val) {
                    var index = enumerationRenderStore.findExact('enumerationLiteralEnu', 'VirtualPartyNameCodeList::'+val);
