Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.partyName.OrganizationNameV1FormSearch',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.organizationnamev1formsearch',
        ...
        },
        {
            ...
            store: new Ext.data.Store({
                ...
                proxy: {
                    ...
                    extraParams: {
                        enumName: 'OrganizationNameUsageCodeList'
                    },
                    reader: {
                        rootProperty: 'datos',
