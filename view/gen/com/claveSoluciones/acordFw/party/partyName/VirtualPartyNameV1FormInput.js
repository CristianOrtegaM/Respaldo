Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.partyName.VirtualPartyNameV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.virtualpartynamev1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    },
                    {
                        ...
                        name: 'effectivePeriodStartDateTimePan',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    },
                    {
                        ...
                        name: 'effectivePeriodEndDateTimePan',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    items:[
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'VirtualPartyNameCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
