Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.partyName.PersonNameV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.personnamev1forminput',
    fieldDefaults: {
        labelAlign: 'top',
                    ...
                    },
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'PersonNameUsageCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
