Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductCompositionV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.productcompositionv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Diseñadores',
                        emptyText: 'Ingrese Diseñadores',
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Período Efectivo Final',
                        emptyText: 'Ingrese Período Efectivo Final',
                    ...
                    {
                        xtype: 'label',
                        text : 'Especificación Base de Producto Asociado',
                        cls: 'x-label-req',
                        afterLabelTextTpl: [
                            '<span style="color:red;font-weight:bold" data-qtip="Campo requerido">*</span>'
                        ],
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'associatedProductSpecificationBasePraGrid',
                                autoScroll: true,
                                height: '',
                                store: new Ext.data.Store({
                                ...
                                xtype: 'button',
                                itemId: 'associatedProductSpecificationBasePraPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#associatedProductSpecificationBasePraPanelGrid');
                                    if(grid.isHidden()){
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'associatedProductSpecificationBasePraPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#associatedProductSpecificationBasePraPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="associatedProductSpecificationBasePraPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#associatedProductSpecificationBasePraGrid');
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Período Efectivo Inicial',
                        emptyText: 'Ingrese Período Efectivo Inicial',
                    ...
                    {
                        xtype: 'numericfield',
                        fieldLabel: 'Cantidad de Componentes Mínima',
                        emptyText: 'Ingrese Cantidad de Componentes Mínima',
                    ...
                    {
                        xtype: 'numericfield',
                        fieldLabel: 'Cantidad de Componentes Máxima',
                        emptyText: 'Ingrese Cantidad de Componentes Máxima',
                    ...
                    {
                        xtype: 'numericfield',
                        fieldLabel: 'Calculation Order',
                        emptyText: 'Ingrese Calculation Order',
                    ...
                    },
                    {
                        ...
                        emptyText: 'Ingrese Display Order',
