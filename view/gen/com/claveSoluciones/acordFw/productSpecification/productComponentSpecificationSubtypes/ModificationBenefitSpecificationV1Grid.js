Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ModificationBenefitSpecificationV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.modificationbenefitspecificationv1grid',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ModificationBenefitSpecificationV1',
    initComponent: function() {
        this.columns = [
            ...
            {
                header: 'Código de la Modificación de Beneficio',
