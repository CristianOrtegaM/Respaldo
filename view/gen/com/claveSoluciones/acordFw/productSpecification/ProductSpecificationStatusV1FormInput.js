Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationStatusV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.productspecificationstatusv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
                    ...
                    items:[
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'ProductStatusCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
