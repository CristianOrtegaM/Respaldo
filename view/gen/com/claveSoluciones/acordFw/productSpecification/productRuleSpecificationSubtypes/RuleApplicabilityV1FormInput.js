Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.RuleApplicabilityV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.ruleapplicabilityv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    items:[
                    {
                        ...
                        emptyText: 'Ingrese basicDataCompleteCode',
