Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeDataValueV1FormSearch',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.attributedatavaluev1formsearch',
    ...
    items: [
        {
            ...
            name: 'attributeDataValueIdentifierAdv_fs',
            columnWidth: .25,
            decimalPrecision: 0,
            padding: '0 10 10 0',
            hideTrigger: true,
        ...
        },
        {
            ...
            store: new Ext.data.Store({
                ...
                proxy: {
                    ...
                    extraParams: {
                        enumName: 'ComplexDataTypeCodeList'
                    },
                    reader: {
                        rootProperty: 'datos',
