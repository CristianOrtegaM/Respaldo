Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1Grid',{
    ...
    initComponent: function() {
        var me = this;
        var lStore = Ext.create('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1');
        Ext.apply(me, {
            store: lStore
        });
        this.columns = [
