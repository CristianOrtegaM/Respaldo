Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.ProductRuleV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.productrulev1forminput',
    fieldDefaults: {
        labelAlign: 'top',
...
//                        regexText: 'Campo inválido',
                    ...
                    },
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Puede Ser Sobreescrito',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
