Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.ProductRuleV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.productrulev1grid',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    //store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.ProductRuleV1',
    initComponent: function() {
        var me = this;
        var lStore = Ext.create('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.ProductRuleV1');
