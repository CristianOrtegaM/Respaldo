Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.PerilV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.perilv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                xtype: 'button',
                                itemId: 'includedPerilPerPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#includedPerilPerPanelGrid');
                                    if(grid.isHidden()){
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'includedPerilPerPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#includedPerilPerPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="includedPerilPerPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#includedPerilPerGrid');
