Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.capabilityv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Nivel de Autorización',
                        emptyText: 'Ingrese Nivel de Autorización',
                        name: 'authorizationLevelCap',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'owningCapabilityCapGrid',
                                autoScroll: true,
                                height: '',
                                store: new Ext.data.Store({
                                ...
                                xtype: 'button',
                                itemId: 'owningCapabilityCapPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#owningCapabilityCapPanelGrid');
                                    if(grid.isHidden()){
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'owningCapabilityCapPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#owningCapabilityCapPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="owningCapabilityCapPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#owningCapabilityCapGrid');
                    ...
                    {
                        xtype: 'label',
                        text : 'Capacidadades Dependientes',
                        padding : '5 5 5 5',
                        columnWidth : 1
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                xtype: 'button',
                                itemId: 'ownedCapabilityCapPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#ownedCapabilityCapPanelGrid');
                                    if(grid.isHidden()){
                                        grid.setVisible(true);
                                        grid.on('afterlayout', function(){
                                            this.center();
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'ownedCapabilityCapPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#ownedCapabilityCapPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="ownedCapabilityCapPanelGridButton"]');
                                                button[button.length-1].toggle();
                                            }
                                        });
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            tooltip: 'Agregar',
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#ownedCapabilityCapGrid');
                                                var store = screen[screen.length-1].getStore();
                                                if(store.findExact('capabilityIdentifierCap', rec.get('capabilityIdentifierCap'))==-1)
