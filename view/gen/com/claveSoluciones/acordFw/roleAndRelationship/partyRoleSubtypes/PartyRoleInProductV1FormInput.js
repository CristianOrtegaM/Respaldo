Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.partyroleinproductv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'rolePlayerPeriodStartDateTime',
                        emptyText: 'Ingrese rolePlayerPeriodStartDateTime',
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'rolePlayerPeriodEndDateTime',
                        emptyText: 'Ingrese rolePlayerPeriodEndDateTime',
                    ...
                    items:[
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'partyRoleKind',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'partyRoleKindPar',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'PartyRoleKTypeCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
                    ...
                    {
                        xtype: 'label',
                        text : 'Especificación de Producto',
                        padding : '5 5 5 5',
                        columnWidth : 1
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'involvingProductSpecificationRprGrid',
                                autoScroll: true,
                                height: '',
                                store: new Ext.data.Store({
                                ...
                                xtype: 'button',
                                itemId: 'involvingProductSpecificationRprPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#involvingProductSpecificationRprPanelGrid');
                                    if(grid.isHidden()){
                                        grid.setVisible(true);
                                        grid.on('afterlayout', function(){
                                            this.center();
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'involvingProductSpecificationRprPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#involvingProductSpecificationRprPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="involvingProductSpecificationRprPanelGridButton"]');
                                                button[button.length-1].toggle();
                                            }
                                        });
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            tooltip: 'Agregar',
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#involvingProductSpecificationRprGrid');
                                                var store = screen[screen.length-1].getStore();
                                                if(store.findExact('specificationIdentifierSpe', rec.get('specificationIdentifierSpe'))==-1)
                                                store.loadRawData(rec.data,false);
                                                Ext.toast({html: 'Se agregó el registro seleccionado.', title: 'Registro Agregado', closable: false, align: 't', slideInDuration: 400,  minWidth: 400});
