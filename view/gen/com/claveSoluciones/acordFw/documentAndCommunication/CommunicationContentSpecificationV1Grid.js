Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationContentSpecificationV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.communicationcontentspecificationv1grid',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationContentSpecificationV1',
    initComponent: function() {
        this.columns = [
            {
                header: 'Nº de Rating de Vehículo',
