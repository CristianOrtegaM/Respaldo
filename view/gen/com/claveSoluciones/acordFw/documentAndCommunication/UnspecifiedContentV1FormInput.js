Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.unspecifiedcontentv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'directedContactPointComGrid',
                                autoScroll: true,
                                height: '',
                                store: new Ext.data.Store({
                                ...
                                xtype: 'button',
                                itemId: 'directedContactPointComPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#directedContactPointComPanelGrid');
                                    if(grid.isHidden()){
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'directedContactPointComPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#directedContactPointComPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="directedContactPointComPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#directedContactPointComGrid');
                                                var store = screen[screen.length-1].getStore();
                                                if(store.findExact('contactPointIdentifierCop', rec.get('contactPointIdentifierCop'))==-1)
                    ...
                    },
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Unspecified Content Kind',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'unspecifiedContentKindUnc',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'UnspecifiedContentKTypeCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
