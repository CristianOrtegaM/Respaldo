Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationStatusV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.communicationstatusv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    items:[
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Communication Status Kind',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'communicationStatusKindCms',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'CommunicationStatusKTypeCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
                    ...
                    },
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'CommunicationStatusCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
