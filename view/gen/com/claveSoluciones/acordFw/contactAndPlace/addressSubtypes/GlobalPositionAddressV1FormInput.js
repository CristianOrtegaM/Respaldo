Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.GlobalPositionAddressV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.globalpositionaddressv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    },
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Coordinate System Code',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'coordinateSystemCodeGpa',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'GeographicCoordinateSystemCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                                    successProperty: 'valido',
