Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.GlobalPositionAddressV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.globalpositionaddressv1grid',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.GlobalPositionAddressV1',
    viewConfig: {
        listeners: {
