Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.TelephoneNumberV1FormSearch',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.telephonenumberv1formsearch',
    ...
    items: [
        {
            xtype: 'textfield',
            fieldLabel: 'Código de Área',
            emptyText: 'Ingrese Código de Área',
            name: 'areaExternalCodeTen_fs',
            columnWidth: .25,
            padding: '0 10 10 0',
            regex: searchReg1,
        ...
        {
            xtype: 'textfield',
            fieldLabel: 'Código de Ciudad',
            emptyText: 'Ingrese Código de Ciudad',
            name: 'countryExternalCodeTen_fs',
            columnWidth: .25,
            padding: '0 10 10 0',
            regex: searchReg1,
            regexText: 'Campo inválido',
        ...
        },
        {
            ...
            emptyText: 'Ingrese Extensión',
            name: 'extensionTen_fs',
            columnWidth: .25,
            padding: '0 10 10 0',
            regex: searchReg1,
            regexText: 'Campo inválido',
        ...
        {
            xtype: 'textfield',
            fieldLabel: 'Número Completo',
            emptyText: 'Ingrese Número Completo',
            name: 'fullNumberTen_fs',
            columnWidth: .25,
            padding: '0 10 10 0',
            regex: searchReg1,
            regexText: 'Campo inválido',
        ...
        },
        {
            xtype: 'textfield',
            fieldLabel: 'Prefijo',
            emptyText: 'Ingrese Prefijo',
            name: 'trunkPrefixTen_fs',
            columnWidth: .25,
            padding: '0 10 10 0',
            regex: searchReg1,
            regexText: 'Campo inválido',
