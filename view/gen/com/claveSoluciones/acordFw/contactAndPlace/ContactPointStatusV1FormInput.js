Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.ContactPointStatusV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.contactpointstatusv1forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    items:[
                    {
                        ...
                        store: new Ext.data.Store({
                            ...
                            proxy: {
                                ...
                                extraParams: {
                                    enumName: 'ContactStatusCodeList'
                                },
                                reader: {
                                    rootProperty: 'datos',
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Fecha y Hora Efectiva',
                        emptyText: 'Ingrese Fecha y Hora Efectiva',
                        name: 'effectiveDateTimeSta',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
