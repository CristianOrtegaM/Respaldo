Ext.define('AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.ContactPreferenceV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.contactpreferencev1forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Descripción del Propósito',
                        emptyText: 'Ingrese Descripción del Propósito',
                        name: 'purposeCop',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                    ...
                    },
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Lista Roja',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'redListIndicatorCop',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            items:[{
                                ...
                                itemId: 'preferredContactPointCopGrid',
                                autoScroll: true,
                                height: '',
                                ...
                                xtype: 'button',
                                itemId: 'preferredContactPointCopPanelGridButton',
                                cls: 'boton-objeto',
                                style: {
                                    'float': 'right',
                                    'margin': '10px'
                                ...
                                handler: function(){
                                    this.toggle();
                                    var grid = this.up('fieldset').down('#preferredContactPointCopPanelGrid');
                                    if(grid.isHidden()){
                            ...
                            border: false,
                            padding: 10,
                            itemId: 'preferredContactPointCopPanelGrid',
                            hidden: true,
                            floating: true,
                            draggable: true, 
                            width: '85%',
                                ...
                                listeners: {
                                    afterrender: function(){
                                        ...
                                        toolbar.add({
                                            ...
                                            text : 'Cerrar',
                                            handler : function(){
                                                var screen = Ext.ComponentQuery.query('#preferredContactPointCopPanelGrid');
                                                var win = screen[screen.length-1];
                                                win.setVisible(false);
                                                var button = Ext.ComponentQuery.query('button[itemId="preferredContactPointCopPanelGridButton"]');
                                        ...
                                        var column = Ext.create('Ext.grid.column.Action',{
                                            ...
                                            handler: function(grid, rowIndex,colIndex, item, e, rec){
                                                var screen = Ext.ComponentQuery.query('#preferredContactPointCopGrid');
                    ...
                    {
                        xtype: 'datefield',
                        fieldLabel: 'Última Validación',
                        emptyText: 'Ingrese Última Validación',
                        name: 'lastValidatedDateCop',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Instrucciones de Contacto',
                        emptyText: 'Ingrese Instrucciones de Contacto',
                        name: 'contactInstructionsCop',
                        allowBlank: true,
                        hidden: false,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                    ...
                    },
                    {
                        xtype: 'combo',
                        forceSelection: true,
                        fieldLabel: 'Solicitable',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'solicitableIndicatorCop',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
