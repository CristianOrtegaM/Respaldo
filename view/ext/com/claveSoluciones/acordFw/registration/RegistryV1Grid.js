Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.registration.RegistryV1Grid',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.registryv1grid_ext',
    loadMask: true,
    autoScroll: true,
    cls: 'fondo-paginador',
    store:'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.registration.RegistryV1',
    initComponent: function() {
        this.columns = [
           {
                header: 'Nº de Registro',
                dataIndex: 'registryIdentifierReg',
                sortable: true,
                align: 'right',
                hidden: false,
                width: 120
