Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.category.AccountingCategoryV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.accountingcategoryv1forminput_ext',
    fieldDefaults: {
        labelAlign: 'top',
