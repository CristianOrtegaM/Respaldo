Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.category.HeterogeneousTreeOutputCompany', {
    extend: 'Ext.tree.Panel',
    alias: 'widget.heterogeneoustreeoutputcompany',
    xtype: 'heterogeneoustreeoutputcompany',
    rootVisible: false,
    animate: false,
    frame: true,
