Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.PlaceProximityV2PrincipalForm',{
    extend: 'Ext.form.Panel',
    alias: 'widget.placeproximityv2principalform_ext',
    ...
    title: 'Asociación de Zona Geográfica',
    border: false,
    fieldDefaults: {
        labelAlign: 'top',
        labelWidth: 85,
