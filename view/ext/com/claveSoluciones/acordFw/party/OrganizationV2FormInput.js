Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.party.OrganizationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.organizationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    items:[
                    {
                        ...
                        emptyText: 'Ingrese Nombre Legal',
                        name: 'fullNamePanLegal',
                        allowBlank: false,
                        afterLabelTextTpl: [
