Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.ExternalCodeV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.externalcodev1forminput_ext',
    fieldDefaults: {
        labelAlign: 'top',
