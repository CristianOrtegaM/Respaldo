Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1FormSearch',{
    ...
    items: [
        ...
        {
            xtype: 'datefield',
            fieldLabel: 'Fecha de Cambio (Desde)',
            emptyText: 'Ingrese Fecha de Cambio (Desde)',
            name: 'asOfDateExrFrom',
            columnWidth: .25,
            padding: '0 10 10 0',
            format: 'd/m/Y',
            submitFormat: 'c',
        ...
        {
            xtype: 'datefield',
            fieldLabel: 'Fecha de Cambio (Hasta)',
            emptyText: 'Ingrese Fecha de Cambio (Hasta)',
            name: 'asOfDateExrTo',
            columnWidth: .25,
            padding: '0 10 10 0',
            format: 'd/m/Y',
