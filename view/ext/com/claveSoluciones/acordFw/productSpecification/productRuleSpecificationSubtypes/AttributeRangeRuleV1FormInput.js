Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.attributerangerulev1forminput',
    fieldDefaults: {
        labelAlign: 'top',
    ...
    initComponent: function() {
        this.items = [{
            ...
            items: [{
                ...
                {
                    xtype:'fieldset',
                    title: 'Especificación de Regla de Atributo de Rango',
                    collapsible: true,
                    hidden: false,
                    columnWidth: 1,
                    layout: 'column',
...
//                    },
                    {
                        ...
                        emptyText: 'Ingrese Valor Mínimo',
                        name: 'minimumValueArr',
                        allowBlank: false,
                        afterLabelTextTpl: [
                            '<span style="color:red;font-weight:bold" data-qtip="Campo requerido">*</span>'
                        ],
                    ...
                    },
                    {
                        ...
                        emptyText: 'Ingrese Valor Máximo',
                        name: 'maximumValueArr',
                        allowBlank: false,
                        afterLabelTextTpl: [
                            '<span style="color:red;font-weight:bold" data-qtip="Campo requerido">*</span>'
                        ],
