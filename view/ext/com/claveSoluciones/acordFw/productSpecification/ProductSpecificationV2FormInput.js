Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.productspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Producto',
                        emptyText: 'Ingrese Código de Producto',
                    ...
                    },
                    {
        	            ...
        	            listeners: {
                          ...
                          change: function(combo, nv, oldValue){
                          	var newValue = nv;
                          	if(newValue!=null && typeof newValue=='string' && newValue.length>2 && newValue!=oldValue && combo.getStore().getTotalCount()>30){
