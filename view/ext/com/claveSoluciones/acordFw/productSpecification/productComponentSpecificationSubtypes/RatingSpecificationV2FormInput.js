Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.ratingspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Rating General',
                        emptyText: 'Ingrese Código de Rating General',
