Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LimitSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.limitspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Límite',
                        emptyText: 'Ingrese Código de Límite',
