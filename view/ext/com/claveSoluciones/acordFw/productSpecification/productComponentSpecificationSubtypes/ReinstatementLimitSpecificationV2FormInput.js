Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ReinstatementLimitSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.reinstatementlimitspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código  de Restablecimiento de Límite',
                        emptyText: 'Ingrese Código de Restablecimiento de Límite',
