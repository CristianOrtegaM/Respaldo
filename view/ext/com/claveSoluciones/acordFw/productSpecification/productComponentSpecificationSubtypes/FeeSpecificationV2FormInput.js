Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.feespecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Cargo',
                        emptyText: 'Ingrese Código de Cargo',
