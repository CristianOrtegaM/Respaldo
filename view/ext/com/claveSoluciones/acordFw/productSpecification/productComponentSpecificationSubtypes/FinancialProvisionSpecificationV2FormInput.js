Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.financialprovisionspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Provisión Financiera',
                        emptyText: 'Ingrese Código de Provisión Financiera',
