Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.vehicleratingspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Rating de Vehículo',
                        emptyText: 'Ingrese Código de Rating de Vehículo',
