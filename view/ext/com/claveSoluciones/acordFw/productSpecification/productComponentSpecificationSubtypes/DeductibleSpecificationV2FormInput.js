Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.deductiblespecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Deducible',
                        emptyText: 'Ingrese Código de Deducible',
