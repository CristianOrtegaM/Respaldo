Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.taxdeductionspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    xtype:'fieldset',  
                    title: 'Especificación de Deducción de Impuesto',
                    collapsible: true,
                    hidden: false,
                    columnWidth: 1,
                    layout: 'column',
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de la Deducción de Impuesto',
                        emptyText: 'Ingrese Código de la Deducción de Impuesto',
