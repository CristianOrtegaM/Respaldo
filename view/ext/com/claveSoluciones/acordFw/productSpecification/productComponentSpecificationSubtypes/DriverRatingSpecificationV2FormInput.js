Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.driverratingspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Rating de Conductor',
                        emptyText: 'Ingrese Código de Rating de Conductor',
