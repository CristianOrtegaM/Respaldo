Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.insuredratingspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Rating de Asegurado',
                        emptyText: 'Ingrese Código de Rating de Asegurado',
