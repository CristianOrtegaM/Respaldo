Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PremiumFactorSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.premiumfactorspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Factor de Prima',
                        emptyText: 'Ingrese Código de Factor de Prima',
