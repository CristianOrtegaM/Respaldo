Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.structuralcomponentspecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Componente Estructural',
                        emptyText: 'Ingrese Código de Componente Estructural',
