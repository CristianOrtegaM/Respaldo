Ext.define('AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV2FormInput',{
    extend: 'Ext.form.FormPanel',
    alias: 'widget.clausespecificationv2forminput',
    fieldDefaults: {
        labelAlign: 'top',
        ...
        this.items = [{
            ...
            items: [{
                ...
                items: [
                {
                    ...
                    {
                        xtype: 'textfield',
                        fieldLabel: 'Código de Cláusula',
                        emptyText: 'Ingrese Código de Cláusula',
                    ...
                    {
                        xtype: 'combo',
                        fieldLabel: 'Detalles Adicionales Requeridos',
                        autoLoadOnValue: true,
                        emptyText: 'Seleccione ...',
                        name: 'additionalDetailsRequiredIndicatorCls',
                        allowBlank: true,
                        columnWidth: .25,
                        padding: '0 10 10 0',
                        queryMode: 'local',
