Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.contactAndPlace.ContactPointStatusV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'contactPointStatusService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
