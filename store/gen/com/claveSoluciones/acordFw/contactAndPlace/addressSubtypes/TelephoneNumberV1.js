Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.TelephoneNumberV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'telephoneNumberService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
