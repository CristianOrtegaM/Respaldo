Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.PlaceAddressV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'placeAddressService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
