Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductRuleSpecificationV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'productRuleSpecificationService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
            filters : Ext.encode([Ext.create ('AFW_FND_Xjs.model.util.Filtro', {
                nombreCampo: 'class',
                valor: 'ProductRuleSpecification',
                valores: null,
                operacion: '=',
                tipoValor: 'string'
            }).data])
