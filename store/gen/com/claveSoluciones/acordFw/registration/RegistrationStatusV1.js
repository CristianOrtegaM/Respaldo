Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.registration.RegistrationStatusV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'registrationStatusService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
