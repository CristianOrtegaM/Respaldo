Ext.define('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationStatusV1', {
    ...
    proxy:  {
        type: 'rest',
        url: urlService + 'communicationStatusService/findByFilter',
        actionMethods:  {
            read: 'POST'
        },
        extraParams:{
