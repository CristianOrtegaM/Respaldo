Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1', {
    ...
    views:  [
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1PrincipalWindow',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1FormInput',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.addressSubtypes.StreetAddressV1Grid',
    ...
    update: function(btn) {
        ...
        btn.up('window').mask("Guardando", "x-mask-loading");
        streetAddressV1.getProxy().setUrl(streetAddressV1.getProxy().getInitialConfig('url') + '/' + streetAddressV1.getId());
        streetAddressV1.getProxy().setAppendId(false);
        streetAddressV1.save ({
            callback: function (record, operation) {
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
			...
			if (paramValues.typeExternalCodeSta != "" && paramValues.typeExternalCodeSta != null) {
                var typeExternalCodeSta = Ext.create ('AFW_FND_Xjs.model.util.Filtro', {
                    nombreCampo: 'typeExternalCodeSta',
                    valor: paramValues.typeExternalCodeSta+'%',
                    operacion: 'like',
                    tipoValor: 'string'
                });
                filtro.push(typeExternalCodeSta.data);
            }
            ...
            if (paramValues.numberSta != "" && paramValues.numberSta != null) {
                var numberSta = Ext.create ('AFW_FND_Xjs.model.util.Filtro', {
                    nombreCampo: 'numberSta',
                    valor: paramValues.numberSta+'%',
                    operacion: 'like',
                    tipoValor: 'string'
                });
