Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.contactAndPlace.PlaceProximityV2', {
    ...
    stores: ['AFW_FND_Xjs.store.ext.com.claveSoluciones.acordFw.contactAndPlace.PlaceNodeZ'],
    views: [
        'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.PlaceProximityV2PrincipalForm',
        'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.HeterogeneousTreeV2',
        'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.contactAndPlace.ContextMenuV2'
    ],
    init: function() {
        var me = this;
        this.control({
            ...
            'listsContextMenuv2 menuitem': {
                click: me.showSeleccionarAsociacion
            },
            '#asociacionv2 button[action=asociarLugar]': {
    ...
    refs: [
        {
            ...
            selector: 'heterogeneoustreev2'
        },
        {
            ref: 'contextMenu',
            selector: 'listsContextMenuv2',
            xtype: 'listsContextMenuv2',
            autoCreate: true
        }
    ],
    ...
    mostrarWindows: function(btn) {
        var me = this;
        var storeplacenode = Ext.getStore('AFW_FND_Xjs.store.ext.com.claveSoluciones.acordFw.contactAndPlace.PlaceNodeZ');
	...
	hideMenu: function (contextMenu) {
	var newAsociarPais = contextMenu.down('#asociar_pais'),
    ...
    showContextMenu: function(view, record, node, rowIndex, e) {
		...
		//GeographicRegion
        if (record.data.type === 'GeographicRegion') {
			newAsociarPais.show();
            ...
            newDesasociar.hide();
		} else if (record.data.type === 'Country') {
			this.hideMenu (contextMenu);
    ...
    showSeleccionarAsociacion: function(component, e) {
        ...
        if (component.action === 'desasociar') {
			...
			if (component.itemId === 'asociar_pais') {
                ...
                storePlace = 'AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.CountryV1';
                gridType = 'countryv1grid_ext';
                tipo = 'Country';
                nombreCampo_2 = 'namePla';
            } else if (component.itemId === 'asociar_region') {
                    ...
                    items: [
                        {
                            ...
                            tbar: Ext.create('Ext.toolbar.Toolbar', {
                                ...
                                items: [{
                                        ...
                                        xtype: 'textfield',
                                        itemId: 'searchlive',
                                        store: Ext.StoreMgr.lookup(storePlace),
                                         triggers: {
						        			filter: {
                            ...
                            listeners: {
                                afterrender: function(grid) {
                                    grid.getStore().load({
										callback : function () {
											Ext.ComponentQuery.query ('#asociacionv2')[0].center ();
										}
									});
                                }
                            }
