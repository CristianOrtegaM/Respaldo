Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.PartyRoleInAgreementSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.PartyRoleInAgreementSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.PartyRoleInAgreementSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.PartyRoleInAgreementSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            ...
            'partyroleinagreementspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'partyroleinagreementspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (partyRoleInAgreementSpecificationV1Record !== undefined 
                ...
                partyRoleInAgreementSpecificationV1.getProxy().setUrl(urlService+'partyRoleInAgreementSpecificationService');
		  		partyRoleInAgreementSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.PartyRoleInAgreementSpecificationV1', respuesta.data);
                                record.getProxy().setUrl(urlService+'partyRoleInAgreementSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.PartyRoleInRelationshipSpecificationV2');
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('partyroleinagreementspecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('partyroleinagreementspecificationv2principalwindow');  
    ...
    showControlledPartyRoleInRelationshipSpecificationPri: function(grid, rowIndex,colIndex, item, e, rec){
        AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.PartyRoleInRelationshipSpecificationV1');
        var ventana = Ext.create('Ext.window.Window',{
            width : 850,
            title : grid.headerCt.items.items[item].text,
            modal : true,
