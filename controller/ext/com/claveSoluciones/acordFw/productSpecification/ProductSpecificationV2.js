Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'productspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'productspecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'productspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'productspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (productSpecificationV1Record !== undefined 
				...
				productSpecificationV1.getProxy().setUrl(urlService+'productSpecificationService');
		  		productSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV1', respuesta.data);
                                record.getProxy().setUrl(urlService+'productSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productspecificationv2principalwindow');
...
//	            		                		this.remove(toolbar);
            ...
            callback: function (record, operation) {
                if (operation.success === true) {
                    ...
                    if (respuesta.valido === true) {
                        ...
                        Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV1').reload();
                        var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV1', respuesta.data);
                        Ext.ComponentQuery.query('productspecificationv2forminput')[0].getForm().loadRecord(record);
                        if(record.data.statusPrs!=null && record.data.statusPrs != []){
                        	btn.up('window').down('textfield[name="status"]').setValue(record.data.statusPrs.nameSta);                        	
                        } 
                    } else {
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('productspecificationv2principalwindow');  
    ...
    showStatusPrs: function(grid, rowIndex,colIndex, item, e, rec){
    	AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationStatus');
