Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV2PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'feespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'feespecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'feespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'feespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (feeSpecificationV1Record !== undefined 
                ...
                feeSpecificationV1.getProxy().setUrl(urlService+'feeSpecificationService');
		   		feeSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'feeSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('feespecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('feespecificationv2principalwindow');
