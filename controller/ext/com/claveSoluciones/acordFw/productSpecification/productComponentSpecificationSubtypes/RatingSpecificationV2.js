Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'ratingspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'ratingspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'ratingspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'ratingspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'ratingspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'ratingspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'ratingspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'ratingspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'ratingspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var ratingSpecificationV1Record =  form.getRecord();
            if (ratingSpecificationV1Record !== undefined 
                && ratingSpecificationV1Record !== null 
                && ratingSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && ratingSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(ratingSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('RatingSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var ratingSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, ratingSpecificationV1);
                ratingSpecificationV1.getProxy().setUrl(urlService+'ratingSpecificationService');
		   		ratingSpecificationV1.getProxy().setAppendId(false);
                ratingSpecificationV1.set(objeto);
                ratingSpecificationV1.set({
                ...
                var ratingSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1Validation', {});
                var validations = ratingSpecificationV1Validation.createValidations (ratingSpecificationV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'ratingSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('ratingspecificationv2principalwindow');
            window.setTitle('Especificación de Rating General Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var ratingSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, ratingSpecificationV1);
        ratingSpecificationV1.set (objeto);
        ratingSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('ratingspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('ratingspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
