Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV2FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'healthcoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'healthcoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'healthcoveragespecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'healthcoveragespecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'healthcoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'healthcoveragespecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'healthcoveragespecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'healthcoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'healthcoveragespecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var healthCoverageSpecificationV1Record =  form.getRecord();
            if (healthCoverageSpecificationV1Record !== undefined 
                && healthCoverageSpecificationV1Record !== null 
                && healthCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && healthCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(healthCoverageSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('HealthCoverageSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var healthCoverageSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, healthCoverageSpecificationV1);
               	healthCoverageSpecificationV1.getProxy().setUrl(urlService+'healthCoverageSpecificationService');
		   		healthCoverageSpecificationV1.getProxy().setAppendId(false);      
                healthCoverageSpecificationV1.set(objeto);
                healthCoverageSpecificationV1.set({
                ...
                var healthCoverageSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1Validation', {});
                var validations = healthCoverageSpecificationV1Validation.createValidations (healthCoverageSpecificationV1);
                var errors = null;
                ...
                healthCoverageSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'healthCoverageSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('healthcoveragespecificationv2principalwindow');
            window.setTitle('Especificación de Cobertura de Salud Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, true, false);
        var healthCoverageSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, healthCoverageSpecificationV1);
        healthCoverageSpecificationV1.set (objeto);
        healthCoverageSpecificationV1.set({
            includedPerilCos: includedPerilCos,
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('healthcoveragespecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('healthcoveragespecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
