Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV2FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'financialprovisionspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'financialprovisionspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'financialprovisionspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'financialprovisionspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'financialprovisionspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'financialprovisionspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'financialprovisionspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'financialprovisionspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'financialprovisionspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var financialProvisionSpecificationV1Record =  form.getRecord();
            if (financialProvisionSpecificationV1Record !== undefined 
                && financialProvisionSpecificationV1Record !== null 
                && financialProvisionSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && financialProvisionSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(financialProvisionSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('FinancialProvisionSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var financialProvisionSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, financialProvisionSpecificationV1);
                financialProvisionSpecificationV1.getProxy().setUrl(urlService+'financialProvisionSpecificationService');
				financialProvisionSpecificationV1.getProxy().setAppendId(false);
                financialProvisionSpecificationV1.set(objeto);
                financialProvisionSpecificationV1.set({
                ...
                var financialProvisionSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1Validation', {});
                var validations = financialProvisionSpecificationV1Validation.createValidations (financialProvisionSpecificationV1);
                var errors = null;
                ...
                financialProvisionSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            var respuesta = Ext.decode(operation._response.responseText);
                            if (respuesta.valido === true) {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'financialProvisionSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('financialprovisionspecificationv2principalwindow');
            window.setTitle('Especificación de Provisión Financiera Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var financialProvisionSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, financialProvisionSpecificationV1);
        financialProvisionSpecificationV1.set (objeto);
        financialProvisionSpecificationV1.set({
//            designerSpe: designerSpe,
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('financialprovisionspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('financialprovisionspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
