Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LiabilityCoverageSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LiabilityCoverageSpecificationV2PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LiabilityCoverageSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'liabilitycoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'liabilitycoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'liabilitycoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'liabilitycoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (liabilityCoverageSpecificationV1Record !== undefined 
                ...
                liabilityCoverageSpecificationV1.getProxy().setUrl(urlService+'liabilityCoverageSpecificationService');
	   			liabilityCoverageSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LiabilityCoverageSpecificationV1', respuesta.data);
                                record.getProxy().setUrl(urlService+'liabilityCoverageSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('liabilitycoveragespecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('liabilitycoveragespecificationv2principalwindow');
