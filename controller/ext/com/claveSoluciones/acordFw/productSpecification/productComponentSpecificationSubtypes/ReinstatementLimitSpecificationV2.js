Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ReinstatementLimitSpecificationV2', {
    ...
    views: [
        ...
        'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ReinstatementLimitSpecificationV2PrincipalWindow',
        ...
        'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ReinstatementLimitSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'reinstatementlimitspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'reinstatementlimitspecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'reinstatementlimitspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'reinstatementlimitspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    edit: function(btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('reinstatementlimitspecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.category.CategoryMembershipV1');
        var ventana = Ext.widget('reinstatementlimitspecificationv2principalwindow');
