Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialSchedulerOptionSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialSchedulerOptionSpecificationV2PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialSchedulerOptionSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'financialscheduleroptionspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'financialscheduleroptionspecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'financialscheduleroptionspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'financialscheduleroptionspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (financialSchedulerOptionSpecificationV1Record !== undefined 
				...
				financialSchedulerOptionSpecificationV1.getProxy().setUrl(urlService+'financialSchedulerOptionSpecificationService');
		   		financialSchedulerOptionSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialSchedulerOptionSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'financialSchedulerOptionSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('financialscheduleroptionspecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('financialscheduleroptionspecificationv2principalwindow');
