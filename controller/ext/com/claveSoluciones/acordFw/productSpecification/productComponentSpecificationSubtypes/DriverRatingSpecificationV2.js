Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV2FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'driverratingspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'driverratingspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'driverratingspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'driverratingspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'driverratingspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'driverratingspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'driverratingspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'driverratingspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'driverratingspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var driverRatingSpecificationV1Record =  form.getRecord();
            if (driverRatingSpecificationV1Record !== undefined 
                && driverRatingSpecificationV1Record !== null 
                && driverRatingSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && driverRatingSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(driverRatingSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('DriverRatingSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var driverRatingSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, driverRatingSpecificationV1);
                driverRatingSpecificationV1.getProxy().setUrl(urlService+'driverRatingSpecificationService');
		   		driverRatingSpecificationV1.getProxy().setAppendId(false);
                driverRatingSpecificationV1.set(objeto);
                driverRatingSpecificationV1.set({
                ...
                var driverRatingSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1Validation', {});
                var validations = driverRatingSpecificationV1Validation.createValidations (driverRatingSpecificationV1);
                var errors = null;
                ...
                driverRatingSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'driverRatingSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('driverratingspecificationv2principalwindow');
            window.setTitle('Especificación de Rating de Conductor Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var driverRatingSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, driverRatingSpecificationV1);
        driverRatingSpecificationV1.set (objeto);
        driverRatingSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('driverratingspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('driverratingspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
