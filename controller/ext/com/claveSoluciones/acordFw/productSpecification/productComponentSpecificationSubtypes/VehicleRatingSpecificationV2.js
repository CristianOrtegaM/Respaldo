Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'vehicleratingspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'vehicleratingspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'vehicleratingspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'vehicleratingspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'vehicleratingspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'vehicleratingspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'vehicleratingspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'vehicleratingspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'vehicleratingspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var vehicleRatingSpecificationV1Record =  form.getRecord();
            if (vehicleRatingSpecificationV1Record !== undefined 
                && vehicleRatingSpecificationV1Record !== null 
                && vehicleRatingSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && vehicleRatingSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(vehicleRatingSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('VehicleRatingSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var vehicleRatingSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, vehicleRatingSpecificationV1);
                vehicleRatingSpecificationV1.getProxy().setUrl(urlService+'vehicleRatingSpecificationService');
		   		vehicleRatingSpecificationV1.getProxy().setAppendId(false);
                vehicleRatingSpecificationV1.set(objeto);
                vehicleRatingSpecificationV1.set({
                ...
                var vehicleRatingSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1Validation', {});
                var validations = vehicleRatingSpecificationV1Validation.createValidations (vehicleRatingSpecificationV1);
                var errors = null;
                ...
                vehicleRatingSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'vehicleRatingSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('vehicleratingspecificationv2principalwindow');
            window.setTitle('Especificación de Rating de Vehículo Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var vehicleRatingSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, vehicleRatingSpecificationV1);
        vehicleRatingSpecificationV1.set (objeto);
        vehicleRatingSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('vehicleratingspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	 if(btn.up('form').getForm().isValid()){
             btn.setDisabled(true);
             var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1');
             store.removeAll ();
             store.filters.clear();
             delete store.getProxy().extraParams['filters'];
			...
			paramValues = this.application.getConvertion().convert (paramValues, store.getModel());
             ...
             invalidFields = btn.up('viewport').down('vehicleratingspecificationv1formsearch').query("field{isValid()==false}");
             var msg = "Formulario no válido. Complete los campos requeridos:<br />";
             for (var i = 0; i<invalidFields.length; i++){
                 msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                     for(var j = 0; j<invalidFields[i].getErrors().length; j++){
