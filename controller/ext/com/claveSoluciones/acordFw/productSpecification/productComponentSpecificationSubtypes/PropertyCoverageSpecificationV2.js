Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'propertycoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'propertycoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'propertycoveragespecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'propertycoveragespecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'propertycoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'propertycoveragespecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'propertycoveragespecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'propertycoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'propertycoveragespecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var propertyCoverageSpecificationV1Record =  form.getRecord();
            if (propertyCoverageSpecificationV1Record !== undefined 
                && propertyCoverageSpecificationV1Record !== null 
                && propertyCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && propertyCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(propertyCoverageSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('PropertyCoverageSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var propertyCoverageSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, propertyCoverageSpecificationV1);
                propertyCoverageSpecificationV1.getProxy().setUrl(urlService+'propertyCoverageSpecificationService');
		   		propertyCoverageSpecificationV1.getProxy().setAppendId(false);
                propertyCoverageSpecificationV1.set(objeto);
                propertyCoverageSpecificationV1.set({
                ...
                var propertyCoverageSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1Validation', {});
                var validations = propertyCoverageSpecificationV1Validation.createValidations (propertyCoverageSpecificationV1);
                var errors = null;
                ...
                propertyCoverageSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1', respuesta.data);
 								record.getProxy().setUrl(urlService+'propertyCoverageSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('propertycoveragespecificationv2principalwindow');
            window.setTitle('Especificación de Cobertura de Propiedad Nº ' + seleccion[0].get('specificationIdentifierSpe'));
            ...
            window.show(undefined,function(){
            	window.down('#includedPerilCosGrid').getStore().add(seleccion[0].get('includedPerilCos'));
            	window.down('#excludedPerilCosGrid').getStore().add(seleccion[0].get('excludedPerilCos'));
            });
            btn.setDisabled(false);
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, true, false);
        var propertyCoverageSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, propertyCoverageSpecificationV1);
        propertyCoverageSpecificationV1.set (objeto);
        propertyCoverageSpecificationV1.set({
            includedPerilCos: includedPerilCos,
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('propertycoveragespecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('propertycoveragespecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
