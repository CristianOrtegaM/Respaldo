Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV2FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'taxdeductionspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'taxdeductionspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'taxdeductionspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'taxdeductionspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'taxdeductionspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'taxdeductionspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'taxdeductionspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'taxdeductionspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'taxdeductionspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var taxDeductionSpecificationV1Record =  form.getRecord();
            if (taxDeductionSpecificationV1Record !== undefined 
                && taxDeductionSpecificationV1Record !== null 
                && taxDeductionSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && taxDeductionSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(taxDeductionSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('TaxDeductionSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var taxDeductionSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, taxDeductionSpecificationV1);
                taxDeductionSpecificationV1.getProxy().setUrl(urlService+'taxDeductionSpecificationService');
		   		taxDeductionSpecificationV1.getProxy().setAppendId(false);
                taxDeductionSpecificationV1.set(objeto);
                taxDeductionSpecificationV1.set({
                    ...
                    statusPrs: null,
                    typeNameImo: 'TaxDeductionSpecification'
                });
                var taxDeductionSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1Validation', {});
                var validations = taxDeductionSpecificationV1Validation.createValidations (taxDeductionSpecificationV1);
                var errors = null;
                ...
                taxDeductionSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'taxDeductionSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('taxdeductionspecificationv2principalwindow');
            window.setTitle('Especificación de Impuesto Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var taxDeductionSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, taxDeductionSpecificationV1);
        taxDeductionSpecificationV1.set (objeto);
        taxDeductionSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('taxdeductionspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.TaxDeductionSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('taxdeductionspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
