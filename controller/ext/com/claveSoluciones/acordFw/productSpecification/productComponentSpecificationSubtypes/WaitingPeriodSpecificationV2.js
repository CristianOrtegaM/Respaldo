Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'waitingperiodspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'waitingperiodspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'waitingperiodspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'waitingperiodspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'waitingperiodspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'waitingperiodspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'waitingperiodspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'waitingperiodspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'waitingperiodspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var waitingPeriodSpecificationV1Record =  form.getRecord();
            if (waitingPeriodSpecificationV1Record !== undefined 
                && waitingPeriodSpecificationV1Record !== null 
                && waitingPeriodSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && waitingPeriodSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(waitingPeriodSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('WaitingPeriodSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var waitingPeriodSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, waitingPeriodSpecificationV1);
                waitingPeriodSpecificationV1.getProxy().setUrl(urlService+'waitingPeriodSpecificationService');
		   		waitingPeriodSpecificationV1.getProxy().setAppendId(false);
                waitingPeriodSpecificationV1.set(objeto);
                waitingPeriodSpecificationV1.set({
                ...
                var waitingPeriodSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1Validation', {});
                var validations = waitingPeriodSpecificationV1Validation.createValidations (waitingPeriodSpecificationV1);
                var errors = null;
                ...
                waitingPeriodSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'waitingPeriodSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('waitingperiodspecificationv2principalwindow');
            window.setTitle('Especificación de Período de Carencia Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var waitingPeriodSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, waitingPeriodSpecificationV1);
        waitingPeriodSpecificationV1.set (objeto);
        waitingPeriodSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('waitingperiodspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.WaitingPeriodSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('waitingperiodspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
