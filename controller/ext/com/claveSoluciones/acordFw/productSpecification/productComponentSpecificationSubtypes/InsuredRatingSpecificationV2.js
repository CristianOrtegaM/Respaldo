Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV2FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'insuredratingspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'insuredratingspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'insuredratingspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'insuredratingspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'insuredratingspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'insuredratingspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'insuredratingspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'insuredratingspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'insuredratingspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var insuredRatingSpecificationV1Record =  form.getRecord();
            if (insuredRatingSpecificationV1Record !== undefined 
                && insuredRatingSpecificationV1Record !== null 
                && insuredRatingSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && insuredRatingSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(insuredRatingSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('InsuredRatingSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var insuredRatingSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, insuredRatingSpecificationV1);
                insuredRatingSpecificationV1.getProxy().setUrl(urlService+'insuredRatingSpecificationService');
		   		insuredRatingSpecificationV1.getProxy().setAppendId(false);
                insuredRatingSpecificationV1.set(objeto);
                insuredRatingSpecificationV1.set({
                ...
                var insuredRatingSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1Validation', {});
                var validations = insuredRatingSpecificationV1Validation.createValidations (insuredRatingSpecificationV1);
                var errors = null;
                ...
                insuredRatingSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'insuredRatingSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('insuredratingspecificationv2principalwindow');
            window.setTitle('Especificación de Rating de Asegurado Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var insuredRatingSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, insuredRatingSpecificationV1);
        insuredRatingSpecificationV1.set (objeto);
        insuredRatingSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('insuredratingspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('insuredratingspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
