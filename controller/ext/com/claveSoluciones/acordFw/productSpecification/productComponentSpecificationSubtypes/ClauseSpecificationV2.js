Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'clausespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'clausespecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'clausespecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'clausespecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'clausespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'clausespecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'clausespecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'clausespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'clausespecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var clauseSpecificationV1Record =  form.getRecord();
            if (clauseSpecificationV1Record !== undefined 
                && clauseSpecificationV1Record !== null 
                && clauseSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && clauseSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(clauseSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('ClauseSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var clauseSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, clauseSpecificationV1);
                clauseSpecificationV1.getProxy().setUrl(urlService+'clauseSpecificationService');
		   		clauseSpecificationV1.getProxy().setAppendId(false);
                clauseSpecificationV1.set(objeto);
                clauseSpecificationV1.set({
                ...
                var clauseSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1Validation', {});
                var validations = clauseSpecificationV1Validation.createValidations (clauseSpecificationV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1', respuesta.data);
                                record.getProxy().setUrl(urlService+'clauseSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('clausespecificationv2principalwindow');
            window.setTitle('Especificación de Cláusula Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var clauseSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, clauseSpecificationV1);
        clauseSpecificationV1.set (objeto);
        clauseSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('clausespecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('clausespecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
