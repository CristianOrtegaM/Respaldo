Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DisabilityCoverageSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DisabilityCoverageSpecificationV2PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DisabilityCoverageSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'disabilitycoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'disabilitycoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'disabilitycoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'disabilitycoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (disabilityCoverageSpecificationV1Record !== undefined 
                ...
                disabilityCoverageSpecificationV1.getProxy().setUrl(urlService+'disabilityCoverageSpecificationService');
		   		disabilityCoverageSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DisabilityCoverageSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'disabilityCoverageSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('disabilitycoveragespecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('disabilitycoveragespecificationv2principalwindow');
