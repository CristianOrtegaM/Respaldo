Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'deductiblespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'deductiblespecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'deductiblespecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'deductiblespecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'deductiblespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'deductiblespecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'deductiblespecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'deductiblespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'deductiblespecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var deductibleSpecificationV1Record =  form.getRecord();
            if (deductibleSpecificationV1Record !== undefined 
                && deductibleSpecificationV1Record !== null 
                && deductibleSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && deductibleSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(deductibleSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('DeductibleSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var deductibleSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, deductibleSpecificationV1);
                deductibleSpecificationV1.getProxy().setUrl(urlService+'deductibleSpecificationService');
		   		deductibleSpecificationV1.getProxy().setAppendId(false);
                deductibleSpecificationV1.set(objeto);
                deductibleSpecificationV1.set({
                ...
                var deductibleSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1Validation', {});
                var validations = deductibleSpecificationV1Validation.createValidations (deductibleSpecificationV1);
                var errors = null;
                ...
                deductibleSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'deductibleSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('deductiblespecificationv2principalwindow');
            window.setTitle('Especificación de Deducible Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var deductibleSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, deductibleSpecificationV1);
        deductibleSpecificationV1.set (objeto);
        deductibleSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('deductiblespecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DeductibleSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('deductiblespecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
