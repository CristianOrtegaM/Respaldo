Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'structureratingspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'structureratingspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'structureratingspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'structureratingspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'structureratingspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'structureratingspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'structureratingspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'structureratingspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'structureratingspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var structureRatingSpecificationV1Record =  form.getRecord();
            if (structureRatingSpecificationV1Record !== undefined 
                && structureRatingSpecificationV1Record !== null 
                && structureRatingSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && structureRatingSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(structureRatingSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('StructureRatingSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var structureRatingSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, structureRatingSpecificationV1);
                structureRatingSpecificationV1.getProxy().setUrl(urlService+'structureRatingSpecificationService');
		   		structureRatingSpecificationV1.getProxy().setAppendId(false);
                structureRatingSpecificationV1.set(objeto);
                structureRatingSpecificationV1.set({
                ...
                var structureRatingSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1Validation', {});
                var validations = structureRatingSpecificationV1Validation.createValidations (structureRatingSpecificationV1);
                var errors = null;
                ...
                structureRatingSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'structureRatingSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('structureratingspecificationv2principalwindow');
            window.setTitle('Especificación de Rating de Estructura Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var structureRatingSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, structureRatingSpecificationV1);
        structureRatingSpecificationV1.set (objeto);
        structureRatingSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('structureratingspecificationv2principalwindow');
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('structureratingspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
