Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'structuralcomponentspecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'structuralcomponentspecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'structuralcomponentspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'structuralcomponentspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'structuralcomponentspecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'structuralcomponentspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'structuralcomponentspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'structuralcomponentspecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'structuralcomponentspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var structuralComponentSpecificationV1Record =  form.getRecord();
            if (structuralComponentSpecificationV1Record !== undefined 
                && structuralComponentSpecificationV1Record !== null 
                && structuralComponentSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && structuralComponentSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(structuralComponentSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('StructuralComponentSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var structuralComponentSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1', {});
				objeto = this.application.getConvertion().convert (objeto, structuralComponentSpecificationV1);
                structuralComponentSpecificationV1.getProxy().setUrl(urlService+'structuralComponentSpecificationService');
		   		structuralComponentSpecificationV1.getProxy().setAppendId(false);
                structuralComponentSpecificationV1.set(objeto);
                structuralComponentSpecificationV1.set({
                ...
                var structuralComponentSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1Validation', {});
                var validations = structuralComponentSpecificationV1Validation.createValidations (structuralComponentSpecificationV1);
                var errors = null;
                ...
                structuralComponentSpecificationV1.save ({
...
//                                btn.up('window').close();
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1').reload();
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1', respuesta.data);
                                record.getProxy().setUrl(urlService+'structuralComponentSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('structuralcomponentspecificationv2principalwindow');
            window.setTitle('Especificación de Componente Estructural Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var form = btn.up('window').down('form').getForm();
        var objeto = form.getValues(false, true, false);
        var structuralComponentSpecificationV1 = form.getRecord();
		objeto = this.application.getConvertion().convert (objeto, structuralComponentSpecificationV1);
        structuralComponentSpecificationV1.set (objeto);
        structuralComponentSpecificationV1.set({
            updateUserImo: usuario.get('userName'),
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('structuralcomponentspecificationv2principalwindow');
    ...
    buscar: function(btn) {
    	if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructuralComponentSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('structuralcomponentspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
