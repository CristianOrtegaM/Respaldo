Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV2PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV2FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'suretybondcoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'suretybondcoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
                    click: this.printDependentComponents
            },
            'suretybondcoveragespecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'suretybondcoveragespecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'suretybondcoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            'suretybondcoveragespecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'suretybondcoveragespecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'suretybondcoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
            'suretybondcoveragespecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        var includedPerilCosGrid = btn.up('window').down('#includedPerilCosGrid').getStore();
        var excludedPerilCos = null;
        var excludedPerilCosGrid = btn.up('window').down('#excludedPerilCosGrid').getStore();
        if(form.isValid()
            ...
            var suretyBondCoverageSpecificationV1Record =  form.getRecord();
            if (suretyBondCoverageSpecificationV1Record !== undefined 
                && suretyBondCoverageSpecificationV1Record !== null 
                && suretyBondCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && suretyBondCoverageSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(suretyBondCoverageSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('SuretyBondCoverageSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var suretyBondCoverageSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1', {});
                objeto = this.application.getConvertion().convert (objeto, suretyBondCoverageSpecificationV1);
                suretyBondCoverageSpecificationV1.getProxy().setUrl(urlService+'suretyBondCoverageSpecificationService');
		   		suretyBondCoverageSpecificationV1.getProxy().setAppendId(false);      
                suretyBondCoverageSpecificationV1.set(objeto);
                suretyBondCoverageSpecificationV1.set({
                ...
                var suretyBondCoverageSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1Validation', {});
                var validations = suretyBondCoverageSpecificationV1Validation.createValidations (suretyBondCoverageSpecificationV1);
                var errors = null;
                ...
                suretyBondCoverageSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1').reload();
                                var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'suretyBondCoverageSpecificationService/'+record.getId());
            ...
            if(includedPerilCosGrid.count()==0){
                ...
                msg += '<b>- ' + label.config.text + '</b>. No puede estar vacío. <br />';
            }
            crearVentana(5,msg);
            btn.setDisabled(false);
        }
    ...
    edit: function (btn) {
        ...
        AFW_FND_Xjs.getApplication().loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.PerilV1');
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('suretybondcoveragespecificationv2principalwindow');
            window.setTitle('Especificación de Cobertura de Garantía Nº ' + seleccion[0].get('specificationIdentifierSpe'));
            ...
            /*window.down('button[action=create]').up('toolbar').insert(1,{
             ...
             var includedPerilCosGrid = this.up('window').down('#includedPerilCosGrid').getStore();
            ...
            window.show(undefined, function() {
                window.down('#includedPerilCosGrid').getStore().loadData(seleccion[0].get('includedPerilCos'));
                window.down('#excludedPerilCosGrid').getStore().loadData(seleccion[0].get('excludedPerilCos'));
            });
            btn.setDisabled(false);
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, true, false);
        var suretyBondCoverageSpecificationV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, suretyBondCoverageSpecificationV1);
        suretyBondCoverageSpecificationV1.set (objeto);
        suretyBondCoverageSpecificationV1.set({
            includedPerilCos: includedPerilCos,
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('suretybondcoveragespecificationv2principalwindow');
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('suretybondcoveragespecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
