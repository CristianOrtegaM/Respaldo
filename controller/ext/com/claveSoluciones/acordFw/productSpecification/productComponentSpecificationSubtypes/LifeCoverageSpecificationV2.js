Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LifeCoverageSpecificationV2', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LifeCoverageSpecificationV2PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LifeCoverageSpecificationV2FormInput',
    ...
    init: function() {
        this.control({
            'lifecoveragespecificationv2forminput menuitem[action=printComponentStructure]' : {
                    click: this.printComponentStructure
            },
            'lifecoveragespecificationv2forminput menuitem[action=printDependentComponents]' : {
            ...
            'lifecoveragespecificationv2principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'lifecoveragespecificationv2principalwindow button[action=update]': {
                click: this.update
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (lifeCoverageSpecificationV1Record !== undefined 
                ...
                lifeCoverageSpecificationV1.getProxy().setUrl(urlService+'lifeCoverageSpecificationService');
		   		lifeCoverageSpecificationV1.getProxy().setAppendId(false);
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
								...
								var record = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LifeCoverageSpecificationV1', respuesta.data);
								record.getProxy().setUrl(urlService+'lifeCoverageSpecificationService/'+record.getId());
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('lifecoveragespecificationv2principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        var ventana = Ext.widget('lifecoveragespecificationv2principalwindow');
