Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV2', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1'],

    views:  [
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1PrincipalWindow',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1Validation'
            ],

    init: function() {
        this.control({
            'attributerangerulev1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'attributerangerulev1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'attributerangerulev1principalwindow button[action=create]': {
                click: this.create
            },
            'attributerangerulev1grid button[action=delete]': {
                click: this.deleteElement
            },
            'attributerangerulev1grid button[action=edit]': {
                click: this.edit
            },
            'attributerangerulev1principalwindow button[action=update]': {
                click: this.update
            },
            'attributerangerulev1grid button[action=mostrarWindows]': {
                click: this.mostrarWindows
            },
            'attributerangerulev1forminput button[action=ruleApplicabilityPrsPanelGridButton]': {
...
//        if(form.isValid() && ruleApplicabilityPrsGrid.count()>0){
        if(form.isValid()){
            ...
            var attributeRangeRuleV1Record =  form.getRecord();
            if (attributeRangeRuleV1Record !== undefined 
                && attributeRangeRuleV1Record !== null 
                && attributeRangeRuleV1Record .get('specificationIdentifierSpe')!==null 
                && attributeRangeRuleV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(attributeRangeRuleV1Record.get('specificationIdentifierSpe')).indexOf('AttributeRangeRuleV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var attributeRangeRuleV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1', {});
                objeto = this.application.getConvertion().convert (objeto, attributeRangeRuleV1);
                attributeRangeRuleV1.set(objeto);
                attributeRangeRuleV1.set({
                ...
                var attributeRangeRuleV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1Validation', {});
                var validations = attributeRangeRuleV1Validation.createValidations (attributeRangeRuleV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                //Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1').reload();
                                if(Ext.ComponentQuery.query('#attributeRange').length >= 0){
                                    Ext.ComponentQuery.query('#attributeRange')[Ext.ComponentQuery.query('#attributeRange').length -1].fireEvent('loadTitle', Ext.ComponentQuery.query('#attributeRange')[Ext.ComponentQuery.query('#attributeRange').length-1]);
                                    Ext.ComponentQuery.query('#attributeRange')[Ext.ComponentQuery.query('#attributeRange').length -1].down('grid').getStore().load();
                                }
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
...
//            }
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            ...
            window.setTitle('Regla de Atributo de Rango Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, true, false);
        var attributeRangeRuleV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, attributeRangeRuleV1);
        attributeRangeRuleV1.set (objeto);
        attributeRangeRuleV1.set({
            designerSpe: designerSpe,
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeRangeRuleV1');
            store.removeAll ();
            store.filters.clear();
            delete store.getProxy().extraParams['filters'];
            ...
            invalidFields = btn.up('viewport').down('attributerangerulev1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
