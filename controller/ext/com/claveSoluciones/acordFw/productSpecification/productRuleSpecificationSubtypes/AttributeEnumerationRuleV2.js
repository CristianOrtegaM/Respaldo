Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV2', {
    ...
    views:  [
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV1PrincipalWindow',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV1FormInput',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.AttributeEnumerationRuleV1Grid',
    ...
    init: function() {
        this.control({
            ...
            'attributeenumerationrulev1forminput button[action=ruleApplicabilityPrsPanelGridButton]': {
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                if(Ext.ComponentQuery.query('#attributeEnumeration').length >= 0){
                                    Ext.ComponentQuery.query('#attributeEnumeration')[Ext.ComponentQuery.query('#attributeEnumeration').length-1].fireEvent('loadTitle', Ext.ComponentQuery.query('#attributeEnumeration')[Ext.ComponentQuery.query('#attributeEnumeration').length-1]);
                                    Ext.ComponentQuery.query('#attributeEnumeration')[Ext.ComponentQuery.query('#attributeEnumeration').length -1].down('grid').getStore().load();
                                }
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
...
//            }
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {            
            ...
            window.down('attributedatavaluev1formsearch').down('button[action=buscar]').setDisabled(false);
    ...
    mostrarWindows: function(btn) {
        ...
        delete store.getProxy().extraParams['filters'];
        var searchButton = ventana.down('attributedatavaluev1formsearch').down('button[action=buscar]');
