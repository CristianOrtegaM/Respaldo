Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1', {
    ...
    init: function() {
        this.control({
            ...
            'capabilityv1grid_ext button[action=mostrarWindows]': {
                click: this.mostrarWindows
            },
             'capabilityv1grid_ext button[action=edit]': {
                click: this.edit
            }
        });
    },
    ...
    edit: function (btn) {
        btn.setDisabled(true);
		 ...
		 if (seleccion.length > 0) {
            ...
            //window.down('textfield[name="nameCap"]').setEditable(false);
            window.show();
            btn.setDisabled(false);
        } else {
