Ext.define('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1', {
    extend: 'AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1',
    ...
    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1',
             'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.ExternalCodeV1'],

    views:  [
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1PrincipalForm',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1PrincipalWindow',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1FormSearch',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1FormInput',
             'AFW_FND_Xjs.view.ext.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.commonElements.commonClasses.EnumerationV1Validation'
            ],

    init: function() {
        this.control({
            'enumerationv1formsearch_ext button[action=buscar]': {
                click: this.buscar
            },
            'enumerationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'enumerationv1principalwindow_ext button[action=create]': {
                click: this.create
            },
            'enumerationv1grid_ext button[action=delete]': {
                click: this.deleteElement
            },
            'enumerationv1grid_ext button[action=edit]': {
                click: this.edit
            },
            'enumerationv1principalwindow_ext button[action=update]': {
                click: this.update
            },
            'enumerationv1grid_ext button[action=mostrarWindows]': {
