Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1FormInput',
    ...
    init: function() {
        this.control({
            'unspecifiedcontentv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'unspecifiedcontentv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'unspecifiedcontentv1principalwindow button[action=create]': {
                click: this.create
            },
            'unspecifiedcontentv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'unspecifiedcontentv1grid button[action=edit]': {
                click: this.edit
            },
            'unspecifiedcontentv1principalwindow button[action=update]': {
                click: this.update
            },
            'unspecifiedcontentv1grid actioncolumn[action=showDirectedContactPointCom]': {
                click: this.showDirectedContactPointCom
            },
            'unspecifiedcontentv1grid button[action=mostrarWindows]': {
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('unspecifiedcontentv1principalwindow');
            window.setTitle('Comunicación de Contenido Libre Nº ' + seleccion[0].get('communicationIdentifierCom'));
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationStatusV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.contactAndPlace.ContactPointV1');
        var ventana = Ext.widget('unspecifiedcontentv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('unspecifiedcontentv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
