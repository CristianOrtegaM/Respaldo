Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1Validation'
            ],

    init: function() {
        this.control({
            'partyroleinregistrationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'partyroleinregistrationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'partyroleinregistrationv1principalwindow button[action=create]': {
                click: this.create
            },
            'partyroleinregistrationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'partyroleinregistrationv1grid button[action=edit]': {
                click: this.edit
            },
            'partyroleinregistrationv1principalwindow button[action=update]': {
                click: this.update
            },
            'partyroleinregistrationv1grid actioncolumn[action=showPlayerRoleRol]': {
                click: this.showPlayerRoleRol
            },
            'partyroleinregistrationv1grid actioncolumn[action=showRoleRol]': {
                click: this.showRoleRol
            },
            'partyroleinregistrationv1grid actioncolumn[action=showPlayerPartyPar]': {
                click: this.showPlayerPartyPar
            },
            'partyroleinregistrationv1grid actioncolumn[action=showNamePar]': {
                click: this.showNamePar
            },
            'partyroleinregistrationv1grid actioncolumn[action=showDesignedSpecificationPar]': {
                click: this.showDesignedSpecificationPar
            },
            'partyroleinregistrationv1grid actioncolumn[action=showOwnedCapabilityPar]': {
                click: this.showOwnedCapabilityPar
            },
            'partyroleinregistrationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var partyRoleInRegistrationV1Record =  form.getRecord();
            if (partyRoleInRegistrationV1Record !== undefined 
                && partyRoleInRegistrationV1Record !== null 
                && partyRoleInRegistrationV1Record .get('roleIdentifierRol')!==null 
                && partyRoleInRegistrationV1Record .get('roleIdentifierRol')!==undefined 
                && new String(partyRoleInRegistrationV1Record.get('roleIdentifierRol')).indexOf('PartyRoleInRegistrationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var partyRoleInRegistrationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1', {});
                objeto = this.application.getConvertion().convert (objeto, partyRoleInRegistrationV1);
                partyRoleInRegistrationV1.set(objeto);
                partyRoleInRegistrationV1.set({
                ...
                var partyRoleInRegistrationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1Validation', {});
                var validations = partyRoleInRegistrationV1Validation.createValidations (partyRoleInRegistrationV1);
                var errors = null;
                ...
                partyRoleInRegistrationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('partyroleinregistrationv1principalwindow');
            window.setTitle('Rol de Parte en Registro Nº ' + seleccion[0].get('roleIdentifierRol'));
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (partyRoleInRegistrationV1Record !== undefined 
                ...
                return partyRoleInRegistrationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var partyRoleInRegistrationV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, partyRoleInRegistrationV1);
        partyRoleInRegistrationV1.set (objeto);
        partyRoleInRegistrationV1.set({
            playerRoleRol: playerRoleRol,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.SpecificationV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1');
        var ventana = Ext.widget('partyroleinregistrationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInRegistrationV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('partyroleinregistrationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
