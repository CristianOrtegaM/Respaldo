Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1Validation'
            ],

    init: function() {
        this.control({
            'partyroleinproductv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'partyroleinproductv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'partyroleinproductv1principalwindow button[action=create]': {
                click: this.create
            },
            'partyroleinproductv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'partyroleinproductv1grid button[action=edit]': {
                click: this.edit
            },
            'partyroleinproductv1principalwindow button[action=update]': {
                click: this.update
            },
            'partyroleinproductv1grid actioncolumn[action=showPlayerRoleRol]': {
                click: this.showPlayerRoleRol
            },
            'partyroleinproductv1grid actioncolumn[action=showRoleRol]': {
                click: this.showRoleRol
            },
            'partyroleinproductv1grid actioncolumn[action=showPlayerPartyPar]': {
                click: this.showPlayerPartyPar
            },
            'partyroleinproductv1grid actioncolumn[action=showNamePar]': {
                click: this.showNamePar
            },
            'partyroleinproductv1grid actioncolumn[action=showDesignedSpecificationPar]': {
                click: this.showDesignedSpecificationPar
            },
            'partyroleinproductv1grid actioncolumn[action=showOwnedCapabilityPar]': {
                click: this.showOwnedCapabilityPar
            },
            'partyroleinproductv1grid actioncolumn[action=showInvolvingProductSpecificationRpr]': {
                click: this.showInvolvingProductSpecificationRpr
            },
            'partyroleinproductv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var partyRoleInProductV1Record =  form.getRecord();
            if (partyRoleInProductV1Record !== undefined 
                && partyRoleInProductV1Record !== null 
                && partyRoleInProductV1Record .get('roleIdentifierRol')!==null 
                && partyRoleInProductV1Record .get('roleIdentifierRol')!==undefined 
                && new String(partyRoleInProductV1Record.get('roleIdentifierRol')).indexOf('PartyRoleInProductV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var partyRoleInProductV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1', {});
                objeto = this.application.getConvertion().convert (objeto, partyRoleInProductV1);
                partyRoleInProductV1.set(objeto);
                partyRoleInProductV1.set({
                ...
                var partyRoleInProductV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1Validation', {});
                var validations = partyRoleInProductV1Validation.createValidations (partyRoleInProductV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('partyroleinproductv1principalwindow');
            window.setTitle('Rol de Parte en Producto Nº ' + seleccion[0].get('roleIdentifierRol'));
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var partyRoleInProductV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, partyRoleInProductV1);
        partyRoleInProductV1.set (objeto);
        partyRoleInProductV1.set({
            playerRoleRol: playerRoleRol,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1');
        this.application.loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        var ventana = Ext.widget('partyroleinproductv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('partyroleinproductv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
