Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1', {
    ...
    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1FormSearch',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1Validation'
            ],
    ...
    init: function() {
        this.control({
            ...
            'exchangeratev1principalwindow button[action=create]': {
                click: this.create
            },
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            if (exchangeRateV1Record !== undefined 
                ...
                var exchangeRateV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.commonElements.commonClasses.ExchangeRateV1Validation', {});
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('exchangeratev1principalwindow');
    ...
    mostrarWindows: function(btn) {
        btn.setDisabled(true);
        var ventana = Ext.widget('exchangeratev1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            ...
            if (paramValues.asOfDateExr != "" && paramValues.asOfDateExr != null) {
                var asOfDateExr = Ext.create ('AFW_FND_Xjs.model.util.Filtro', {
                    nombreCampo: 'asOfDateExr',
                    valor: paramValues.asOfDateExr,
                    operacion: '=',
                    tipoValor: 'date'
                });
                filtro.push(asOfDateExr.data);
            }
