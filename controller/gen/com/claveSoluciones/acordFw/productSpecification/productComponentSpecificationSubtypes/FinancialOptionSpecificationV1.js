Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1FormInput',
             ...
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'financialoptionspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'financialoptionspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'financialoptionspecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            'financialoptionspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'financialoptionspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'financialoptionspecificationv1principalwindow button[action=update]': {
                click: this.update
            },
            'financialoptionspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var financialOptionSpecificationV1Record =  form.getRecord();
            if (financialOptionSpecificationV1Record !== undefined 
                && financialOptionSpecificationV1Record !== null 
                && financialOptionSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && financialOptionSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(financialOptionSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('FinancialOptionSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var financialOptionSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1', {});
                objeto = this.application.getConvertion().convert (objeto, financialOptionSpecificationV1);
                financialOptionSpecificationV1.set(objeto);
                financialOptionSpecificationV1.set({
                ...
                var financialOptionSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1Validation', {});
                var validations = financialOptionSpecificationV1Validation.createValidations (financialOptionSpecificationV1);
                var errors = null;
                ...
                financialOptionSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('financialoptionspecificationv1principalwindow');
            window.setTitle('Opción Financiera Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (financialOptionSpecificationV1Record !== undefined 
                ...
                return financialOptionSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var financialOptionSpecificationV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, financialOptionSpecificationV1);
        financialOptionSpecificationV1.set (objeto);
        financialOptionSpecificationV1.set({
            designerSpe: designerSpe,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductAssociationV1');
        var ventana = Ext.widget('financialoptionspecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialOptionSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('financialoptionspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
