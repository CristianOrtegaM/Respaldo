Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1FormInput',
    ...
    init: function() {
        this.control({
            ...
            'healthcoveragespecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'healthcoveragespecificationv1principalwindow button[action=update]': {
                click: this.update
            },
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('healthcoveragespecificationv1principalwindow');
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (healthCoverageSpecificationV1Record !== undefined 
                ...
                return healthCoverageSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.PerilV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.PerilV1');
        var ventana = Ext.widget('healthcoveragespecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
