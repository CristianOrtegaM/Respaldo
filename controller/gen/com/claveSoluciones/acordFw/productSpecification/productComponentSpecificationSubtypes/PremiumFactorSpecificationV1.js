Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PremiumFactorSpecificationV1', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PremiumFactorSpecificationV1PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PremiumFactorSpecificationV1FormInput',
    ...
    init: function() {
        this.control({
            ...
            'premiumfactorspecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'premiumfactorspecificationv1principalwindow button[action=update]': {
                click: this.update
            },
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('premiumfactorspecificationv1principalwindow');
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (premiumFactorSpecificationV1Record !== undefined 
                ...
                return premiumFactorSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    mostrarWindows: function(btn) {
        btn.setDisabled(true);
        var ventana = Ext.widget('premiumfactorspecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
