Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1PrincipalWindow',
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.SuretyBondCoverageSpecificationV1FormInput',
    ...
    init: function() {
        this.control({
            ...
            'suretybondcoveragespecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'suretybondcoveragespecificationv1principalwindow button[action=update]': {
                click: this.update
            },
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('suretybondcoveragespecificationv1principalwindow');
            window.setTitle('Especificación de Cobertura de Fianza Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (suretyBondCoverageSpecificationV1Record !== undefined 
                ...
                return suretyBondCoverageSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.commonElements.commonClasses.PerilV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.PartyRoleV1');
        var ventana = Ext.widget('suretybondcoveragespecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
