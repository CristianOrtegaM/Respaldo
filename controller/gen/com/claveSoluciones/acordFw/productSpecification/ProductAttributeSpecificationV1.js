Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductAttributeSpecificationV1', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductAttributeSpecificationV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductAttributeSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductAttributeSpecificationV1FormInput',
    ...
    init: function() {
        this.control({
            ...
            'productattributespecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            ...
            'productattributespecificationv1principalwindow button[action=update]': {
                click: this.update
            },
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productattributespecificationv1principalwindow');
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (productAttributeSpecificationV1Record !== undefined 
                ...
                return productAttributeSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    mostrarWindows: function(btn) {
        btn.setDisabled(true);
        var ventana = Ext.widget('productattributespecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
