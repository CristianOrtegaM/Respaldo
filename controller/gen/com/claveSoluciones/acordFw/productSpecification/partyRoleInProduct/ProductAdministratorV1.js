Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1Validation'
            ],

    init: function() {
        this.control({
            'productadministratorv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'productadministratorv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'productadministratorv1principalwindow button[action=create]': {
                click: this.create
            },
            'productadministratorv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'productadministratorv1grid button[action=edit]': {
                click: this.edit
            },
            'productadministratorv1principalwindow button[action=update]': {
                click: this.update
            },
            'productadministratorv1grid actioncolumn[action=showPlayerRoleRol]': {
                click: this.showPlayerRoleRol
            },
            'productadministratorv1grid actioncolumn[action=showRoleRol]': {
                click: this.showRoleRol
            },
            'productadministratorv1grid actioncolumn[action=showPlayerPartyPar]': {
                click: this.showPlayerPartyPar
            },
            'productadministratorv1grid actioncolumn[action=showNamePar]': {
                click: this.showNamePar
            },
            'productadministratorv1grid actioncolumn[action=showDesignedSpecificationPar]': {
                click: this.showDesignedSpecificationPar
            },
            'productadministratorv1grid actioncolumn[action=showOwnedCapabilityPar]': {
                click: this.showOwnedCapabilityPar
            },
            'productadministratorv1grid actioncolumn[action=showInvolvingProductSpecificationRpr]': {
                click: this.showInvolvingProductSpecificationRpr
            },
            'productadministratorv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var productAdministratorV1Record =  form.getRecord();
            if (productAdministratorV1Record !== undefined 
                && productAdministratorV1Record !== null 
                && productAdministratorV1Record .get('roleIdentifierRol')!==null 
                && productAdministratorV1Record .get('roleIdentifierRol')!==undefined 
                && new String(productAdministratorV1Record.get('roleIdentifierRol')).indexOf('ProductAdministratorV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var productAdministratorV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1', {});
                objeto = this.application.getConvertion().convert (objeto, productAdministratorV1);
                productAdministratorV1.set(objeto);
                productAdministratorV1.set({
                ...
                var productAdministratorV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1Validation', {});
                var validations = productAdministratorV1Validation.createValidations (productAdministratorV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productadministratorv1principalwindow');
            window.setTitle('Especificación de Administrador de Productos Nº ' + seleccion[0].get('roleIdentifierRol'));
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var productAdministratorV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, productAdministratorV1);
        productAdministratorV1.set (objeto);
        productAdministratorV1.set({
            playerRoleRol: playerRoleRol,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1');
        this.application.loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        var ventana = Ext.widget('productadministratorv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('productadministratorv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
