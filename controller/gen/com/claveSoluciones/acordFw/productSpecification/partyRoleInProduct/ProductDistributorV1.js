Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1Validation'
            ],

    init: function() {
        this.control({
            'productdistributorv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'productdistributorv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'productdistributorv1principalwindow button[action=create]': {
                click: this.create
            },
            'productdistributorv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'productdistributorv1grid button[action=edit]': {
                click: this.edit
            },
            'productdistributorv1principalwindow button[action=update]': {
                click: this.update
            },
            'productdistributorv1grid actioncolumn[action=showPlayerRoleRol]': {
                click: this.showPlayerRoleRol
            },
            'productdistributorv1grid actioncolumn[action=showRoleRol]': {
                click: this.showRoleRol
            },
            'productdistributorv1grid actioncolumn[action=showPlayerPartyPar]': {
                click: this.showPlayerPartyPar
            },
            'productdistributorv1grid actioncolumn[action=showNamePar]': {
                click: this.showNamePar
            },
            'productdistributorv1grid actioncolumn[action=showDesignedSpecificationPar]': {
                click: this.showDesignedSpecificationPar
            },
            'productdistributorv1grid actioncolumn[action=showOwnedCapabilityPar]': {
                click: this.showOwnedCapabilityPar
            },
            'productdistributorv1grid actioncolumn[action=showInvolvingProductSpecificationRpr]': {
                click: this.showInvolvingProductSpecificationRpr
            },
            'productdistributorv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var productDistributorV1Record =  form.getRecord();
            if (productDistributorV1Record !== undefined 
                && productDistributorV1Record !== null 
                && productDistributorV1Record .get('roleIdentifierRol')!==null 
                && productDistributorV1Record .get('roleIdentifierRol')!==undefined 
                && new String(productDistributorV1Record.get('roleIdentifierRol')).indexOf('ProductDistributorV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var productDistributorV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1', {});
                objeto = this.application.getConvertion().convert (objeto, productDistributorV1);
                productDistributorV1.set(objeto);
                productDistributorV1.set({
                ...
                var productDistributorV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1Validation', {});
                var validations = productDistributorV1Validation.createValidations (productDistributorV1);
                var errors = null;
                    ...
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productdistributorv1principalwindow');
            window.setTitle('Especificación de Distribuidor de Productos Nº ' + seleccion[0].get('roleIdentifierRol'));
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var productDistributorV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, productDistributorV1);
        productDistributorV1.set (objeto);
        productDistributorV1.set({
            playerRoleRol: playerRoleRol,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.CapabilityV1');
        this.application.loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        var ventana = Ext.widget('productdistributorv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('productdistributorv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
