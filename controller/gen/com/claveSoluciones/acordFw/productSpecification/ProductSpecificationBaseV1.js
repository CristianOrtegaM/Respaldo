Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1Validation'
            ],

    init: function() {
        this.control({
            'productspecificationbasev1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'productspecificationbasev1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'productspecificationbasev1principalwindow button[action=create]': {
                click: this.create
            },
            'productspecificationbasev1grid button[action=delete]': {
                click: this.deleteElement
            },
            'productspecificationbasev1grid button[action=edit]': {
                click: this.edit
            },
            'productspecificationbasev1principalwindow button[action=update]': {
                click: this.update
            },
            'productspecificationbasev1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var productSpecificationBaseV1Record =  form.getRecord();
            if (productSpecificationBaseV1Record !== undefined 
                && productSpecificationBaseV1Record !== null 
                && productSpecificationBaseV1Record .get('specificationIdentifierSpe')!==null 
                && productSpecificationBaseV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(productSpecificationBaseV1Record.get('specificationIdentifierSpe')).indexOf('ProductSpecificationBaseV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var productSpecificationBaseV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1', {});
                objeto = this.application.getConvertion().convert (objeto, productSpecificationBaseV1);
                productSpecificationBaseV1.set(objeto);
                productSpecificationBaseV1.set({
                ...
                var productSpecificationBaseV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1Validation', {});
                var validations = productSpecificationBaseV1Validation.createValidations (productSpecificationBaseV1);
                var errors = null;
                ...
                productSpecificationBaseV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productspecificationbasev1principalwindow');
            window.setTitle('Especificación del Producto Base Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (productSpecificationBaseV1Record !== undefined 
                ...
                return productSpecificationBaseV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var productSpecificationBaseV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, productSpecificationBaseV1);
        productSpecificationBaseV1.set (objeto);
        productSpecificationBaseV1.set({
            designerSpe: designerSpe,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.roleAndRelationship.PartyRoleV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductAssociationV1');
        var ventana = Ext.widget('productspecificationbasev1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('productspecificationbasev1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
