Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1', {
    extend: 'Ext.app.Controller',

    stores: ['AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1'],

    models: ['AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1'],

    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1FormInput',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1Grid',
             'AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1Validation'
            ],

    init: function() {
        this.control({
            'productcomponentspecificationv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'productcomponentspecificationv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'productcomponentspecificationv1principalwindow button[action=create]': {
                click: this.create
            },
            'productcomponentspecificationv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'productcomponentspecificationv1grid button[action=edit]': {
                click: this.edit
            },
            'productcomponentspecificationv1principalwindow button[action=update]': {
                click: this.update
            },
            'productcomponentspecificationv1grid button[action=mostrarWindows]': {
    ...
    create: function(btn) {
        ...
        if(form.isValid()
            ...
            var productComponentSpecificationV1Record =  form.getRecord();
            if (productComponentSpecificationV1Record !== undefined 
                && productComponentSpecificationV1Record !== null 
                && productComponentSpecificationV1Record .get('specificationIdentifierSpe')!==null 
                && productComponentSpecificationV1Record .get('specificationIdentifierSpe')!==undefined 
                && new String(productComponentSpecificationV1Record.get('specificationIdentifierSpe')).indexOf('ProductComponentSpecificationV1') === -1){
                    btn.setDisabled(false);
                    this.update(btn);
            }else{
                var productComponentSpecificationV1 = Ext.create('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1', {});
                objeto = this.application.getConvertion().convert (objeto, productComponentSpecificationV1);
                productComponentSpecificationV1.set(objeto);
                productComponentSpecificationV1.set({
                ...
                var productComponentSpecificationV1Validation = Ext.create('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1Validation', {});
                var validations = productComponentSpecificationV1Validation.createValidations (productComponentSpecificationV1);
                var errors = null;
                ...
                productComponentSpecificationV1.save ({
                    callback: function (record, operation) {
                        if (operation.success === true) {
                            ...
                            if (respuesta.valido === true) {
                                ...
                                Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1').reload();
                            } else {
                                crearVentana(respuesta.codigo, respuesta.mensaje);
                            }
                        } else {
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('productcomponentspecificationv1principalwindow');
            window.setTitle('Especificación de Componente de Producto Nº ' + seleccion[0].get('specificationIdentifierSpe'));
    ...
    createRecord: function(btn) {
        ...
        if(form.isValid()
            ...
            if (productComponentSpecificationV1Record !== undefined 
                ...
                return productComponentSpecificationV1;
            }
        } else {
            invalidFields = btn.up('window').down('form').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
    ...
    update: function(btn) {
        ...
        var objeto = form.getValues(false, false, false);
        var productComponentSpecificationV1 = form.getRecord();
        objeto = this.application.getConvertion().convert (objeto, productComponentSpecificationV1);
        productComponentSpecificationV1.set (objeto);
        productComponentSpecificationV1.set({
            designerSpe: designerSpe,
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationStatusV1');
        this.application.loadController('AFW_FND_Xjs.controller.ext.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV2');
        var ventana = Ext.widget('productcomponentspecificationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
    ...
    buscar: function(btn) {
        if(btn.up('form').getForm().isValid()){
            btn.setDisabled(true);
            var store = Ext.StoreMgr.lookup('AFW_FND_Xjs.store.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1');
            store.removeAll ();
            store.filters.clear();
            ...
            invalidFields = btn.up('viewport').down('productcomponentspecificationv1formsearch').query("field{isValid()==false}");
            var msg = "Formulario no válido. Complete los campos requeridos:<br />";
            for (var i = 0; i<invalidFields.length; i++){
                msg += '<b>- ' + invalidFields[i].fieldLabel + '</b>. ';
                    for(var j = 0; j<invalidFields[i].getErrors().length; j++){
