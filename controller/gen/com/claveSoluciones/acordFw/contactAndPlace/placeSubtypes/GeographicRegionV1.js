Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.GeographicRegionV1', {
    ...
    views:  [
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.GeographicRegionV1PrincipalForm',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.GeographicRegionV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.GeographicRegionV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.contactAndPlace.placeSubtypes.GeographicRegionV1FormInput',
    ...
    init: function() {
        this.control({
            'geographicregionv1formsearch button[action=buscar]': {
                click: this.buscar
            },
            'geographicregionv1grid button[action=confirmarAccion]': {
                click: this.confirmarAccion
            },
            'geographicregionv1principalwindow button[action=create]': {
                click: this.create
            },
            'geographicregionv1grid button[action=delete]': {
                click: this.deleteElement
            },
            'geographicregionv1grid button[action=edit]': {
                click: this.edit
            },
            'geographicregionv1principalwindow button[action=update]': {
                click: this.update
            },
            'geographicregionv1grid button[action=mostrarWindows]': {
