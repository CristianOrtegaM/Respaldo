Ext.define('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.party.OrganizationV1', {
    ...
    views:  [
             ...
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.OrganizationV1PrincipalWindow',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.OrganizationV1FormSearch',
             'AFW_FND_Xjs.view.gen.com.claveSoluciones.acordFw.party.OrganizationV1FormInput',
    ...
    edit: function (btn) {
        ...
        if (seleccion.length > 0) {
            var window = Ext.widget('organizationv1principalwindow');
    ...
    mostrarWindows: function(btn) {
        ...
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.party.partyName.OrganizationNameV1');
        this.application.loadController('AFW_FND_Xjs.controller.gen.com.claveSoluciones.acordFw.registration.RegistryAuthorityV1');
        var ventana = Ext.widget('organizationv1principalwindow');
        ventana.show();
        btn.setDisabled(false);
    },
