Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'productSpecificationKindPrs', type: 'string', useNull: true, defaultValue: null},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'ProductSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'productSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
