Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productRuleSpecificationSubtypes.CalculationRuleV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'CalculationRule'},
        {name: 'updateDateTimeImo', type: 'date', dateFormat: 'd-m-Y H:i:s'},
        {name: 'updateUserImo', type: 'string'},
        {name: 'productRuleSpecificationKindPrs', type: 'string', useNull: true, defaultValue: 'CalculationRule'},
        ...
        {name: 'formalDefinitionCar', type: 'string'},
        {name: 'calculationKindCodeCar', type: 'string', useNull: true, defaultValue: null},
        ...
        proxy: {
            ...
            url: urlService + 'calculationRuleService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
