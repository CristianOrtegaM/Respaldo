Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductRuleSpecificationV1', {
    extend: 'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductSpecificationBaseV1',
    requires:
        [
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ProductRuleSpecification'},
        ...
        {name: 'productRuleSpecificationKindPrs', type: 'string', useNull: true, defaultValue: null},
        ...
        proxy: {
            ...
            url: urlService + 'productRuleSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
