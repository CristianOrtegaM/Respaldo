Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductAdministratorV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ProductAdministrator'},
        ...
        {name: 'partyRoleInProductKindRpr', type: 'string', useNull: true, defaultValue: 'ProductAdministrator'},
        ...
        proxy: {
            ...
            url: urlService + 'productAdministratorService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
