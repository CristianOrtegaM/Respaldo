Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.partyRoleInProduct.ProductDistributorV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ProductDistributor'},
        ...
        {name: 'partyRoleInProductKindRpr', type: 'string', useNull: true, defaultValue: 'ProductDistributor'},
        ...
        proxy: {
            ...
            url: urlService + 'productDistributorService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
