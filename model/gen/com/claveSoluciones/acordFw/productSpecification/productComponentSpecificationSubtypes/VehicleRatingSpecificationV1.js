Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.VehicleRatingSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'ratingSpecificationKindRas', type: 'string', useNull: true, defaultValue: 'VehicleRatingSpecification'},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'VehicleRatingSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'vehicleRatingSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
