Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DisabilityCoverageSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'coverageSpecificationKindCos', type: 'string', useNull: true, defaultValue: 'DisabilityCoverageSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'DisabilityCoverageSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'disabilityCoverageSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
