Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.InsuredRatingSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'ratingSpecificationKindRas', type: 'string', useNull: true, defaultValue: 'InsuredRatingSpecification'},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'InsuredRatingSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'insuredRatingSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
