Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialSchedulerOptionSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'remittanceTypeCodeFso', type: 'string', useNull: true, defaultValue: null},
        {name: 'remittanceMeansCodeFso', type: 'string', useNull: true, defaultValue: null},
        {name: 'paymentFrequencyCodeFso', type: 'string', useNull: true, defaultValue: null},
        {name: 'paymentDurationUnitCodeFso', type: 'string'},
        {name: 'paymentDurationValueFso', type: 'float'},
        {name: 'annuityPremiumTypeCodeFso', type: 'string', useNull: true, defaultValue: null},
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: 'FinancialSchedulerOptionSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'FinancialSchedulerOptionSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'financialSchedulerOptionSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
