Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'ratingSpecificationKindRas', type: 'string', useNull: true, defaultValue: null},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'RatingSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'ratingSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
