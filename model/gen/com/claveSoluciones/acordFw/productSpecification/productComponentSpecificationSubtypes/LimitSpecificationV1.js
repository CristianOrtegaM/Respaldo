Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LimitSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'limitSpecificationKindLis', type: 'string', useNull: true, defaultValue: null},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'LimitSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'limitSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
