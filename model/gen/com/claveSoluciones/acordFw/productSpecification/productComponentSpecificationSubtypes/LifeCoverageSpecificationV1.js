Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.LifeCoverageSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'coverageSpecificationKindCos', type: 'string', useNull: true, defaultValue: 'LifeCoverageSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'LifeCoverageSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'lifeCoverageSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
