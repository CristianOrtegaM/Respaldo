Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.StructureRatingSpecificationV1', {
    extend: 'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.RatingSpecificationV1',
    requires:
        [
    ...
    fields: [
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: 'RatingSpecification'},
        ...
        {name: 'ratingSpecificationKindRas', type: 'string', useNull: true, defaultValue: 'StructureRatingSpecification'},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'StructureRatingSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'structureRatingSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
