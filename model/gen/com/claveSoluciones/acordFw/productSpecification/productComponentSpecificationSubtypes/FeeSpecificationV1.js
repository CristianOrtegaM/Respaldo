Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FeeSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: 'FeeSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'FeeSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'feeSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
