Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.PropertyCoverageSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'coverageSpecificationKindCos', type: 'string', useNull: true, defaultValue: 'PropertyCoverageSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'PropertyCoverageSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'propertyCoverageSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
