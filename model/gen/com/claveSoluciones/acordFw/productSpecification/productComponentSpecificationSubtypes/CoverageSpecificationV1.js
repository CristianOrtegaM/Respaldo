Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.CoverageSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'CoverageSpecification'},
        ...
        {name: 'coverageSpecificationKindCos', type: 'string', useNull: true, defaultValue: null},
        ...
        proxy: {
            ...
            url: urlService + 'coverageSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
