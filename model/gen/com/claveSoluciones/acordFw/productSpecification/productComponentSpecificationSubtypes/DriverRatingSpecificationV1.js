Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.DriverRatingSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'ratingSpecificationKindRas', type: 'string', useNull: true, defaultValue: 'DriverRatingSpecification'},
        {name: 'specificationKindSpe', type: 'string', useNull: true, defaultValue: 'ProductSpecificationBase'},
        {name: 'typeNameImo', type: 'string', defaultValue: 'DriverRatingSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'driverRatingSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
