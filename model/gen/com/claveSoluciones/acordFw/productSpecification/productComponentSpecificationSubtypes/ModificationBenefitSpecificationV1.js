Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ModificationBenefitSpecificationV1', {
    extend: 'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.BenefitSpecificationV1',
    requires:
        [
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ModificationBenefitSpecification'},
        {name: 'updateDateTimeImo', type: 'date', dateFormat: 'd-m-Y H:i:s'},
        {name: 'updateUserImo', type: 'string'},
        {name: 'benefitSpecificationKindBes', type: 'string', useNull: true, defaultValue: 'ModificationBenefitSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'modificationBenefitSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
