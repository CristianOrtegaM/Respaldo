Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.ClauseSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'additionalDetailsRequiredIndicatorCls', type: 'boolean'},
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: 'ClauseSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ClauseSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'clauseSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
