Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.HealthCoverageSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'coverageSpecificationKindCos', type: 'string', useNull: true, defaultValue: 'HealthCoverageSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'HealthCoverageSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'healthCoverageSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
