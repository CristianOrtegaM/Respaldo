Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.productComponentSpecificationSubtypes.FinancialProvisionSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'exposureBaseFps', type: 'string'},
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: 'FinancialProvisionSpecification'},
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'FinancialProvisionSpecification'},
        ...
        proxy: {
            ...
            url: urlService + 'financialProvisionSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
