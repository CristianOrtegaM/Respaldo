Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.productSpecification.ProductComponentSpecificationV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'ProductComponentSpecification'},
        ...
        {name: 'productComponentSpecificationKindCom', type: 'string', useNull: true, defaultValue: null}],
        ...
        proxy: {
            ...
            url: urlService + 'productComponentSpecificationService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
