Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.documentAndCommunication.UnspecifiedContentV1', {
    extend: 'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationContentV1',
    models:
        [
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'UnspecifiedContent'},
        {name: 'updateDateTimeImo', type: 'date', dateFormat: 'd-m-Y H:i:s'},
        {name: 'updateUserImo', type: 'string'},
        {name: 'keyImo', type: 'string'},
        {name: 'statusCom', reference: 'AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.documentAndCommunication.CommunicationStatusV1'},
        ...
        {name: 'communicationContentKindCoc', type: 'string', useNull: true, defaultValue: 'UnspecifiedContent'},
        ...
        {name: 'unspecifiedContentKindUnc', type: 'string', useNull: true, defaultValue: null}],
        ...
        proxy: {
            ...
            url: urlService + 'unspecifiedContentService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
