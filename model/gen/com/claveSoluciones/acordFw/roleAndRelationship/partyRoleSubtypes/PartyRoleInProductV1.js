Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.roleAndRelationship.partyRoleSubtypes.PartyRoleInProductV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'PartyRoleInProduct'},
        ...
        {name: 'partyRoleInProductKindRpr', type: 'string', useNull: true, defaultValue: null},
        ...
        proxy: {
            ...
            url: urlService + 'partyRoleInProductService',
            actionMethods: {
                create: 'POST',
                read: 'POST',
                update: 'POST',
