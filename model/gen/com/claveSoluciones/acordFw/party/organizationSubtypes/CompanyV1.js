Ext.define('AFW_FND_Xjs.model.gen.com.claveSoluciones.acordFw.party.organizationSubtypes.CompanyV1', {
    ...
    fields: [
        ...
        {name: 'typeNameImo', type: 'string', defaultValue: 'Company'},
        {name: 'updateDateTimeImo', type: 'date', dateFormat: 'd-m-Y H:i:s'},
        {name: 'updateUserImo', type: 'string'},
        {name: 'partyKindPar', type: 'string', useNull: true, defaultValue: 'Organization'},
        {name: 'organizationKindOrg', type: 'string', useNull: true, defaultValue: 'Company'},
