Ext.define('AFW_FND_Xjs.validation.gen.model.com.claveSoluciones.acordFw.party.OrganizationV1Validation', {
    extend: 'Ext.data.Model',
    createValidations: function(organizationV1) {
        var validations = new Array();

        if (organizationV1.data.foundationDateOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.foundationDateOrg,
        ...
        if (organizationV1.data.memberCountOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.memberCountOrg,
                campo1: 'memberCount',
                valor2: 0,
                operacion: '>=',
        ...
        if (organizationV1.data.accountingPeriodEndDateTimeOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.accountingPeriodEndDateTimeOrg,
                campo1: 'accountingPeriodEndDateTime',
                campo2: 'accountingPeriodStartDateTimeOrg',
                valor2: organizationV1.data.accountingPeriodStartDateTimeOrg,
                operacion: '>=',
        ...
        if (organizationV1.data.accountingPeriodEndDateTimeOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.accountingPeriodStartDateTimeOrg,
        ...
        if (organizationV1.data.accountingPeriodStartDateTimeOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.accountingPeriodStartDateTimeOrg,
                campo1: 'accountingPeriodStartDateTime',
                campo2: 'foundationDateOrg',
                valor2: organizationV1.data.foundationDateOrg,
                operacion: '<=',
        ...
        if (organizationV1.data.dissolutionDateOrg !== null) {
            var validation = Ext.create('AFW_FND_Xjs.model.util.Validation', {
                valor1: organizationV1.data.dissolutionDateOrg,
                campo1: 'dissolutionDate',
                valor2: foundationDate,
                operacion: '>=',
